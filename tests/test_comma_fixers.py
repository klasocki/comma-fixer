...
@pytest.mark.parametrize(
    # TODO add 'ha ha' and duplicate last word to all the strings, alt + j, alt or alt + shift + click for multi cursors
    "test_input, expected",
    [
        ['I, am.', 'I am.'],
...
@pytest.mark.parametrize(
    ...
    [
        ...
        [
            ...
            "firing ( QF ) guns mounted in casemates . Lighter guns consisted of eight 47 @-@ millimetre ( 1 @.@ 9 in ), three @-@ pounder Hotchkiss guns and four 47 @-@ millimetre 2 @.@ 5 @-@ pounder Hotchkiss guns . The ship was also equipped with four submerged 18 @-@ inch torpedo tubes, two on each broadside."]
